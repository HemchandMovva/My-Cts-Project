...
//	-----------------------------NEW WAY OF GETTING EXCEPTION MESSAGES---------------------------------------------------------------------------------------------------------------
	...
	public String getInvalidIdExceptionMessage(String id) {
		return "There is no user with user id: "+id;
	}
	
	public String getInvalidDetailsExceptionMessage(UserDetails obj) {
		return "There is an user with user id: "+obj.getUserId();
	}
